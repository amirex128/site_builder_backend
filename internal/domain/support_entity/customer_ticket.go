...
type CustomerTicketEntity struct {
	...
	// Relationships
	Comments   []CustomerCommentEntity   `json:"comments,omitempty" gorm:"foreignKey:CustomerTicketId"`
	Media      []CustomerTicketMediaEntity `json:"media,omitempty" gorm:"foreignKey:CustomerTicketId"`
}

func (CustomerTicketEntity) TableName() string {
	return "Support.CustomerTickets"
} 