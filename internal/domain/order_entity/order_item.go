...
type OrderItemEntity struct {
	...
	OrderId                      string    `json:"order_id" gorm:"column:OrderId" faker:"uuid_digit"`
	...
	// Relationships
	Order                        OrderEntity      `json:"order" gorm:"foreignKey:OrderId"`
	ReturnItem                   *ReturnItemEntity `json:"return_item,omitempty" gorm:"foreignKey:OrderItemId"`
}
